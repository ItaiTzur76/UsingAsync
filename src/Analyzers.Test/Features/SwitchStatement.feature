...
Scenario: a non-async method that returns some Task inside a using-declaration scope in a switch-statement
...
Scenario: a non-async method that returns some generic-Task inside a using-declaration scope in a switch-statement
	Given a non-async method that returns some generic-Task inside a using-declaration scope in a switch-statement
	When UsingAsync diagnostic is performed
	Then the analyzer finds that diagnostic result and suggests the proper code-fix

Scenario: a non-async method that returns some Task not inside a using-declaration scope in all cases of a switch-statement
...
Scenario: a non-async method that returns some generic-Task not inside a using-declaration scope in all cases of a switch-statement
...
Scenario: a non-async method that returns a completed Task inside a using-declaration scope in all cases of a switch-statement
...
Scenario: a non-async method that returns a completed generic-Task inside a using-declaration scope in all cases of a switch-statement
