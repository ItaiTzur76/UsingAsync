...
Scenario: a non-async method that returns some Task inside a using-declaration scope in a while-statement
...
Scenario: a non-async method that returns some generic-Task inside a using-declaration scope in a while-statement
	Given a non-async method that returns some generic-Task inside a using-declaration scope in a while-statement
	When UsingAsync diagnostic is performed
	Then the analyzer finds that diagnostic result and suggests the proper code-fix

Scenario: a non-async method that returns some Task not inside a using-declaration scope in a while-statement
...
Scenario: a non-async method that returns some generic-Task not inside a using-declaration scope in a while-statement
	Given a non-async method that returns some generic-Task not inside a using-declaration scope in a while-statement
	When UsingAsync diagnostic is performed
	Then the analyzer finds no diagnostic results

Scenario: a non-async method that returns a completed Task inside a using-declaration scope in a while-statement
	Given a non-async method that returns a completed Task inside a using-declaration scope in a while-statement
	When UsingAsync diagnostic is performed
	Then the analyzer finds no diagnostic results

Scenario: a non-async method that returns a completed generic-Task inside a using-declaration scope in a while-statement
